...
def landing_page():
    set_background("assets/images/landing.png")
    st.markdown("""
        <style>
            .highlighted-title {
        ...
        <div class="center-container">
            <div class="highlighted-title">Welcome to ECOMMERCE PORTAL</div>
        </div>
    """, unsafe_allow_html=True)

    st.markdown("<br>", unsafe_allow_html=True)

    col5, col0, col1, col2, col3, col4 = st.columns([1, 1, 2, 1, 2, 1])
    with col1:
        if st.button("Login"):
...
def login_page():
    set_background("C:/Users/KARANAM SOWMYA/Downloads/Major_Project/Major_Project/final_project/final_project/assets/images/background.jpg")
    st.title("Login")
    ...
    if st.button("Login"):
        if login_type == "Customer":
            ...
            if email == "employee@axis.com" and password == "admin123":  # Replace with DB check
                st.success("Bank Admin logged in successfully!")
...
def add_to_cart_page():
    set_background("Cassets/images/background.jpg")

    # Sample product data
    items = {
        "Laptop": {"price": 1000.0, "image": "assets/images/laptop.jpg", "description": "HP 15s, 12th Gen Intel Core i3-1215U, 8GB DDR4, 512GB SSD, (Win 11, Office 21, Silver, 1.69kg), Anti-Glare, 15.6-inch (39.6cm) FHD Laptop, Intel UHD Graphics, HD Camera, Dual Speakers, fy5011TU"},
        "Smartphone": {"price": 700.0, "image": "assets/images/smartphone.jpg", "description": "iPhone 16 Pro Max 256 GB: 5G Mobile Phone with Camera Control, 4K 120 fps Dolby Vision and a Huge Leap in Battery Life. Works with AirPods; Natural Titanium"},
        "Tablet": {"price": 500.0, "image": "assets/images/tablet.jpg", "description": "Samsung Galaxy Tab A9+ 27.94 cm (11.0 inch) Display, RAM 8 GB, ROM 128 GB Expandable, Wi-Fi Tablet, Silver"},
        "Smartwatch": {"price": 250.0, "image": "assets/images/smartwatch.jpg", "description": "TFT Display, SpO2, 100 Sports Mode with Auto Detection, Upto 7 Days Battery (2 Days with Heavy Calling) - Jet Black"},
        "Headphones": {"price": 150.0, "image": "assets/images/headphone.jpg", "description": "boAt Rockerz 425 Bluetooth Wireless Over Ear Headphones with Mic Signature Sound, Beast Mode for Gaming, Enx Tech, ASAP Charge, 25H Playtime, Bluetooth V5.2 (Active Black)"},
    }
